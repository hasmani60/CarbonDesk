...
const Analytics = () => {
  ...
  const loadScopeMigrationData = async () => {
    try {
      ...
      const periodData = groupEmissionsByPeriod(emissions, 'month');
    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-center">
          ...
          <div className="text-xl text-gray-600">Loading comprehensive analytics...</div>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="space-y-6 p-6">
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">Add emissions data to see comprehensive analytics</p>
        </div>
      </div>
    );
  }
  ...
  const emissions = getEmissions();
  const timeSeriesData = groupEmissionsByPeriod(emissions, 'month');
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white rounded-xl shadow-sm border p-6 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-2">{overviewStats.totalEntries} entries • CO₂e</p>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600 mb-2">Scope 1</p>
                  <p className="text-3xl font-bold text-emerald-900">
                    {formatLargeNumber(overviewStats.scope1)}
                  </p>
                  <p className="text-xs text-gray-500 mt-2">{overviewStats.scope1Count} entries</p>
                </div>
                <div className="w-12 h-12 bg-emerald-100 rounded-full flex items-center justify-center">
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600 mb-2">Scope 2</p>
                  <p className="text-3xl font-bold text-blue-900">
                    {formatLargeNumber(overviewStats.scope2)}
                  </p>
                  <p className="text-xs text-gray-500 mt-2">{overviewStats.scope2Count} entries</p>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600 mb-2">Scope 3</p>
                  <p className="text-3xl font-bold text-red-900">
                    {formatLargeNumber(overviewStats.scope3)}
                  </p>
                  <p className="text-xs text-gray-500 mt-2">{overviewStats.scope3Count} entries</p>
                </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Distribution by Scope</h3>
              <div className="h-80">
            ...
            {burdenShift?.detected && (
              <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 mb-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-yellow-900 text-lg">Burden Shifting Detected</h4>
                    <p className="text-yellow-800 mt-2">{burdenShift.message}</p>
          ...
          <section>
            ...
            {paretoInsights && (
              <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-6 mb-6">
                <div className="flex items-start space-x-3">
                  <Target className="w-6 h-6 text-emerald-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-emerald-900 text-lg">80/20 Rule Applied</h4>
                    <p className="text-emerald-800 mt-2">{paretoInsights.summary}</p>
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6 mb-6">
              <div className="flex items-center justify-between mb-4">
                ...
                {selectedParent && (
                  <button
                    onClick={resetDrillDown}
                    className="text-sm text-emerald-600 hover:text-emerald-700 flex items-center space-x-1 font-medium"
                  >
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 border-b">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Emissions</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Entries</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">% of Total</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Cumulative %</th>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {paretoData.map((item, index) => (
                      <tr key={index} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 text-sm text-gray-700">{formatLargeNumber(item.value)} CO₂e</td>
                          ...
                          <td className="px-6 py-4 text-sm">
                            {item.canDrill ? (
                              <button
                                ...
                                className="text-emerald-600 hover:text-emerald-700 flex items-center space-x-1 font-medium"
                              >
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
              <div className="bg-white rounded-xl shadow-sm border p-6">
                ...
                <p className="text-xs text-gray-500 mt-2">Period-over-period change</p>
              </div>

              <div className="bg-white rounded-xl shadow-sm border p-6">
                <p className="text-sm font-medium text-gray-600 mb-2">Avg Acceleration</p>
                ...
                <p className="text-xs text-gray-500 mt-2">Change in velocity</p>
              </div>

              <div className="bg-white rounded-xl shadow-sm border p-6">
                <p className="text-sm font-medium text-gray-600 mb-2">Trend Direction</p>
                <p className="text-3xl font-bold text-gray-900 capitalize">
                  {velocityData.summary.trendDirection}
                </p>
                <p className="text-xs text-gray-500 mt-2">Overall momentum</p>
              </div>

              <div className="bg-white rounded-xl shadow-sm border p-6">
                <p className="text-sm font-medium text-gray-600 mb-2">Inflection Points</p>
                <p className="text-3xl font-bold text-blue-600">
                  {velocityData.summary.inflectionPoints}
                </p>
                <p className="text-xs text-gray-500 mt-2">Trend reversals detected</p>
              </div>
            </div>
        ...
        <section>
          ...
          {!maccData || maccOpportunities.length === 0 ? (
            <div className="bg-white rounded-xl shadow-sm border p-12 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">No MACC Opportunities Defined</h3>
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                <div className="bg-white rounded-xl shadow-sm border p-6">
                  <p className="text-sm font-medium text-gray-600 mb-2">Total Potential</p>
                  <p className="text-3xl font-bold text-emerald-600">
                    {formatLargeNumber(maccData.summary.totalAbatementPotential)}
                  </p>
                  <p className="text-xs text-gray-500 mt-2">tCO₂e reduction</p>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border p-6">
                  <p className="text-sm font-medium text-gray-600 mb-2">Avg Cost/Ton</p>
                  <p className={`text-3xl font-bold ${maccData.summary.avgCostPerTon < 0 ? 'text-green-600' : 'text-gray-900'}`}>
                    ${Math.abs(maccData.summary.avgCostPerTon).toFixed(0)}
                  </p>
                  <p className="text-xs text-gray-500 mt-2">Per tCO₂e</p>
                </div>

                <div className="bg-white rounded-xl shadow-sm border p-6">
                  <p className="text-sm font-medium text-gray-600 mb-2">Cost-Effective</p>
                  <p className="text-3xl font-bold text-blue-600">
              ...
              <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-gray-50 border-b">
                      <tr>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Opportunity</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Category</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Abatement Potential</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Cost/tCO₂e</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Total Cost</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Payback</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Priority</th>
                      </tr>
                    </thead>
                    <tbody className="bg-white divide-y divide-gray-200">
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full">
        <div className="px-6 py-4 border-b">
          <h3 className="text-xl font-semibold text-gray-900">Add MACC Opportunity</h3>
          <p className="text-sm text-gray-500 mt-1">Define a new reduction opportunity</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 bg-white transition-colors"
            >
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-2">💡 Negative values indicate cost savings</p>
          </div>

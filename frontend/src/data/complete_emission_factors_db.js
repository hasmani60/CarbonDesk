...
// Helper function to get emission factor - matches your existing format
export const getEmissionFactor = (scope, category, type) => {
  ...
  return factorData || { factor: 1.0, unit: 'kg', co2: 0, ch4: 0, n2o: 0, description: 'Default emission factor' };
};

// Get available units for a category and type - matches your existing format
...
// Calculate emissions - matches your existing format
